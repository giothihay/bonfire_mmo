...
abstract  class  CustomPlayer extends Player {
  ...
  JoystickMoveDirectional get currentDirectional => _currentDirectional;
  ...
  void logPosition() {
    String x = (initPosition.x / tileSize).toString();
    String y = (initPosition.y / tileSize).toString();
    print('move  - x : $x  va y : $y');
  }
